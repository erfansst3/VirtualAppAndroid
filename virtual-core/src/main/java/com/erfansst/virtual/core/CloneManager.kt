...
import java.io.File
data class CloneInfo(val packageName:String,val cloneId:Int,val apk:File,val dataDir:File,val splits:List<File>=emptyList())
...
return CloneInfo(app.packageName,id,apk,data,splits)
}
